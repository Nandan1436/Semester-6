...
public class SignInWithValidCredentialsTest {
  ...
  public void signInWithValidCredentials() {
    ...
    driver.findElement(By.cssSelector("button")).click();
    {
      ...
      wait.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector("span:nth-child(3)")));
    }
    {
    ...
    {
      List<WebElement> elements = driver.findElements(By.cssSelector(".fa-sign-out"));
      assert(elements.size() > 0);
    }
