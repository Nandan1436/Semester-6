...
public class CardPage {
    ...
    public void selectTagColor(String colorName){
        wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("."+colorName))).click();
    }

    public void deselectTagColor(String colorName) {

        driver.findElement(By.cssSelector(".options .fa-tag")).click();


        String selector = ".tags-selector .tag." + colorName;
